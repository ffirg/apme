...
| L111 | Native | low | Inventory group names should not contain hyphens. | Yes | Yes | Yes | — |
...
### Native (100 rules, 91 impl, 58 tested, 4 fixers)
...
| L111 | low | Inventory group names should not contain hyphens. | Yes | Yes | Yes | — |
